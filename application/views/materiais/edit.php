                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="number" class="form-control" name="quantidade" placeholder="Quantidade"
                                    value="<?php echo $material->quantidade ?>">
                                <?php echo form_error('quantidade', '<small class="form-text text-danger">', '</small>'); ?>

                            </div>

                            <div class="col-md-4">
                                <label>Quantidade mínima permitida no estoque</label>
                                <input type="number" class="form-control" name="quantidade_minima"
                                    placeholder="Quantidade mínima" value="<?php echo $material->quantidade_minima ?>">
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea class="form-control form-control-user" name="observacoes"
                                    value="<?php echo $material->observacoes ?>"></textarea>
