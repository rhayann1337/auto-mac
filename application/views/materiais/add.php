          ...
          <form method="POST" name="form_materiais">
            ...
            <div class="form-group row">
              ...
              <div class="col-md-4">
                ...
                <input type="number" class="form-control" name="quantidade" placeholder="Quantidade" value="<?php echo set_value('quantidade'); ?>">
              ...
              <div class="col-md-4">
                <label>Valor</label>
                <input type="number" class="form-control" name="valor" placeholder="Valor" value="<?php echo set_value('valor'); ?>">
              ...
              <div class="col-md-4">
                <label>Modelo</label>
                <input type="text" class="form-control" name="modelo" placeholder="Modelo. Ex: Gol 2008 v16" value="<?php echo set_value('modelo'); ?>">
              ...
              <div class="col-md-12">
                ...
                <textarea class="form-control form-control-user" style="width: 500px;" name="observacoes" value="<?php echo set_value('observacoes'); ?>"></textarea>
            ...
            <div class="form-group row mb-3">
              ...
              <div class="col-md-4">
                <label>Imagem</label>
                <input type="text" class="form-control" name="foto" placeholder="URL da foto" value="<?php echo set_value('foto'); ?>">
