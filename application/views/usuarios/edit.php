        ...
        <div class="container-fluid">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    ...
                    <h6 class="m-0 font-weight-bold text-primary">Editar dados do usuário</h6>
                </div>
                <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                ...
                                <select class="form-control" name="active">
                                    ...
                                    <option value="0" <?php echo ($usuario->active == 0) ? 'selected' : ''; ?>>Não
                                    </option>
                                    <option value="1" <?php echo ($usuario->active == 1) ? 'selected' : ''; ?>>Sim
                                    </option>
