              ...
              <tbody>
                <?php foreach ($usuarios as $user) :  ?>
                  <tr>
                    ...
                    <td class="text-center pr-4"> <?php echo ($user->active == 1 ? '<span class="badge badge-info btn-sm">Ativo</span>' : '<span class="badge badge-danger btn-sm">Inativo</span>') ?></td>
                    <td>
                      <a title="Editar" href="<?php echo ('usuarios/edit/' . $user->id); ?>" class="btn btn-sm btn-primary">Editar</a>
                      <a title="Excluir " href="javascript(void)" data-toggle="modal" data-target="#user-<?php echo $user->id; ?>" class="btn btn-sm btn-danger">Excluir</a>
                    </td>
                  </tr>
                    ...
                    <div class="modal-dialog" role="document">
                      <div class="modal-content">
                        ...
                        <div class="modal-footer">
                          ...
                          <a class="btn btn-danger btn-sm" href="<?php echo base_url('users/del/' . $user->id); ?>">Sim</a>
                        </div>
                      </div>
                    </div>
                  </div>
