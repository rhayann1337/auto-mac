    ...
    <div class="container-fluid">
      ...
      <div class="card shadow mb-4">
        <div class="card-header py-3">
          <a title="Voltar" href="<?php echo base_url() . 'clientes'; ?>" class="btn btn-success btn-sm float-right">Voltar</i></a>
          ...
          <form method="POST" name="form_cliente">
            ...
            <div class="form-group row">
              ...
              <label>Veiculo - Informações completas </label>
                <input type="text" class="form-control" name="veiculo" placeholder="Veiculo" value="<?php echo set_value('veiculo'); ?>">
                <?php echo form_error('veiculo', '<small class="form-text text-danger">', '</small>'); ?>


                <div class="col-md-4">
                <label>Placa</label>
                <input type="text" class="form-control" name="placa" placeholder="Placa" value="<?php echo set_value('placa'); ?>">
