                ...
                <div class="card-body">
                    <form method="POST" name="form_funcionario" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                <label>Nome</label>
                                <input type="text" class="form-control" name="nome_funcionario" placeholder="Nome"
                                    value="<?php echo set_value('nome_funcionario'); ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6 mb-1 mb-sm-0">
                                ...
                                <input type="date" class="form-control form-control-user-date" name="data_nascimento"
