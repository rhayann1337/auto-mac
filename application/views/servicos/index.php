        ...
        <div class="container-fluid">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    ...
                    <a style="margin: 0 16px 0 0;" title="Listagem completa"
                        href="<?php echo base_url('servicos/geral'); ?>" class="btn btn-danger btn-sm float-right"><i
                            class="fas fa-user-plus"></i>&nbsp;Listagem
                        completa de serviços</a>
                    ...
                    <h6 class="m-0 font-weight-bold text-primary">Dados de serviços de 1 mês de diferença da data atual.
                    </h6>
                </div>
                <div class="card-body">
