                ...
                <div class="card-body">
                    <form class="user" action="" id="form" name="form_edit" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                        ...
                        <fieldset id="materiais" class="mt-4 border p-2">
                            ...
                            <legend class="font-small"><i class="fas fa-tools"></i>&nbsp;&nbsp;Escolha os materiais</legend>

                            <div class="form-group row">
                                <div class="ui-widget col-lg-12 mb-1 mt-1">
                                    <input id="buscar_produtos" class="search form-control form-control-lg col-lg-12" placeholder="Que material você está procurando?">
                                </div>
                            </div>
                        ...
                        <fieldset class="mt-4 border p-2">
                            ...
                            <div class="">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-3">
                                        <label class="small my-0">Selecione o funcionário <span class="text-danger">*</span></label>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6 mb-1 mb-sm-0">
                                        <label class="small my-0">Nome do serviço <span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" name="nome_servico" value="<?php echo $servico->nome_servico; ?>">
                                    ...
                                    <div class="col-sm-3 mb-1 mb-sm-0">
                                        ...
                                        <input type="date" class="form-control" name="data" value="<?php echo $servico->data; ?>">
                  ...
                  <option value="1">Não</option>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6 mb-1 mb-sm-0">
                                        ...
                                        <textarea class="form-control form-control-user" name="descricao" value="<?php echo $servico->descricao; ?>"></textarea>
