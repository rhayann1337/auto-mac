          ...
          <form method="POST" name="form_add_orcamento">
            ...
            <div class="form-group row">
              ...
              <div class="col-md-4">
                ...
                <input type="number" class="form-control" name="valor_total" value="<?php echo $orcamento->valor_total; ?>">
              ...
              <div class="col-md-4">
                ...
                <input type="text" class="form-control" name="carro" value="<?php echo $orcamento->carro; ?>">
              ...
              <div class="col-md-4">
                <label>Placa</label>
                <input type="text" class="form-control" name="placa" value="<?php echo $orcamento->placa; ?>">
            ...
            <div class="form-group row mb-3">
              ...
              <div class="col-md-12">
                ...
                <textarea class="form-control form-control-user" name="descricao" value="<?php echo $orcamento->descricao; ?>"></textarea>
