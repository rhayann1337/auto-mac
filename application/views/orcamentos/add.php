                    ...
                    <form method="POST" name="form_add_orcamento">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                ...
                                <label>OBS: Caso não encontre o cliente ou não esteja cadastrado, clique para cadastrar.
                                    <a title="Cadastrar cliente" href="<?php echo base_url() . 'clientes/add'; ?>"
                                        class="btn btn-danger btn-sm">Cadastrar</i></a></label>
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="number" class="form-control" name="valor_total"
                                    value="<?php echo set_value('valor_total'); ?>">
