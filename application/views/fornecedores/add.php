      ...
      <div class="card shadow mb-4">
        ...
        <div class="card-body">
          <form method="POST" name="form_add_fornecedor">
            ...
            <div class="col-md-4">
                <label>Marca</label>
                <input type="text" class="form-control" name="marca" value="<?php echo set_value('marca'); ?>">
                <?php echo form_error('marca', '<small class="form-text text-danger">', '</small>'); ?>
              </div>

              <div class="col-md-4">
                <label>Nome do contato</label>
                <input type="text" class="form-control" name="contato" value="<?php echo set_value('contato'); ?>">
                <?php echo form_error('contato', '<small class="form-text text-danger">', '</small>'); ?>
              </div>

              <div class="col-md-4">
                <label>Telefone</label>
                <input type="number" class="form-control sp_celphones" name="telefone" value="<?php echo set_value('telefone'); ?>">
              ...
              <div class="col-md-4">
                ...
                <input type="text" class="form-control" name="endereco" value="<?php echo set_value('endereco'); ?>">
              ...
              <div class="col-md-4">
                ...
                <textarea class="form-control form-control-user" name="foto" value="<?php echo set_value('foto'); ?>"></textarea>
